package com.example.midichallenge.midi.examples;

import java.io.File;
import java.io.IOException;

import com.example.midichallenge.midi.MidiFile;
import com.example.midichallenge.midi.event.MidiEvent;
import com.example.midichallenge.midi.event.NoteOn;
import com.example.midichallenge.midi.util.MidiEventListener;
import com.example.midichallenge.midi.util.MidiProcessor;
